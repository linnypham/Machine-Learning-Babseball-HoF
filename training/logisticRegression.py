...
# Logistic Regression
batting_model = LogisticRegression(max_iter=1000)
pitching_model = LogisticRegression(max_iter=1000)
...
# Save models
joblib.dump(batting_model, 'models/batting_model_lr.pkl')
joblib.dump(pitching_model, 'models/pitching_model_lr.pkl')
# Plot graphs
