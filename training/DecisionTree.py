...
# Decision Tree
batting_model = DecisionTreeClassifier(random_state=42)
pitching_model = DecisionTreeClassifier(random_state=42)
...
# Save models
joblib.dump(batting_model, 'models/batting_model_dt.pkl')
joblib.dump(pitching_model, 'models/pitching_model_dt.pkl')
# Plot graphs
